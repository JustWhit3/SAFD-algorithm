...
//============================================
inline double huncx( int m, int l, double x, double y ) { return sin( x ) - cos( x ); }
inline double huncx_2( int m, int l, double x, double y ) { return pow( sin( x ), 2 ) - cos( x ); }
inline double huncx_3( int m, int l, double x, double y ) { return pow( sin( x ), 3 ) - cos( x ); }

inline double huncy( int m, int l, double x, double y ) { return sin( y ) - cos( y ); }
inline double huncy_2( int m, int l, double x, double y ) { return pow( sin( y ), 2 ) - cos( y ); }
inline double huncy_3( int m, int l, double x, double y ) { return pow( sin( y ), 8 ) - pow( cos( y ), 3 ); }
inline double huncy_4( int m, int l, double x, double y ) { return pow( sin( y ), 4 ) + pow( cos( y ), 9 ) - pow( cos( y ), 3 ); }

inline double hunc( int m, int l, double x, double y ) { return pow( cos( x ), 5 ) + pow( sin( y ), 4 ); }
